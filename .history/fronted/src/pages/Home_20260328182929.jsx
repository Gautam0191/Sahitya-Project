        ...
        >
          <div className="poetry-card-v2 shadow-sm h-100">
            <div className="card-img-wrapper">
              <img
                /* यहाँ path और ब्लिंकिंग रोकने का फिक्स है */
                src={item.img ? `http://localhost:5000/authors/${item.img}` : "/placeholder.jpg"}
                alt={item.title}
                className="img-fluid"
                loading="lazy"
                onError={(e) => {
                  e.target.onerror = null; // यह लाइन ब्लिंकिंग रोकती है
