  ...
  return (
    <>
      ...
      <div className="card-img-wrapper">
        <img
          /* सीधे आपके public/cover फोल्डर से फोटो उठाएगा */
          src={item.img ? `/cover/${item.img}` : `/cover/default.jpg`}
          alt={item.title}
          className="img-fluid"
          loading="lazy"
          onError={(e) => {
            e.target.onerror = null; // ब्लिंकिंग रोकने के लिए
            /* अगर कोई खास फोटो न मिले, तो cover फोल्डर की ही कोई एक फोटो यहाँ लिख दें */
                  ...
                  <div className="row g-0">
                    <div className="col-md-6 overflow-hidden featured-img-box">
                      <img
                        src={
                          featuredStory.img
                            ? `${API_BASE_URL}/authors/${featuredStory.img}`
                            : "/placeholder.jpg"
                        }
                  ...
                  >
                    <div className="small-card-img">
                      <img
                        src={
                          story.img
                            ? `${API_BASE_URL}/authors/${story.img}`
                            : "/placeholder.jpg"
                        }
