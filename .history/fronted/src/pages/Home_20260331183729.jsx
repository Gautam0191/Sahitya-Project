          ...
          >
            <div className="row g-0">
              <div className="col-md-6 overflow-hidden featured-img-box">
                <img
                  /* सीधे public/cover फोल्डर से */
                  src={featuredStory.img ? `/cover/${featuredStory.img}` : "/cover/default.jpg"}
                  className="img-fluid featured-img"
                  alt={featuredStory.title}
                  onError={(e) => {
                    e.target.onerror = null; // ब्लिंकिंग रोकने के लिए
                    e.target.src = "/cover/default.jpg";
                  }}
                />
              </div>
          ...
          >
            ...
            >
              <div className="small-card-img">
                <img
                  /* सीधे public/cover फोल्डर से */
                  src={story.img ? `/cover/${story.img}` : "/cover/default.jpg"}
