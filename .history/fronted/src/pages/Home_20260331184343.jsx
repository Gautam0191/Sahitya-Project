...
<section className="kahani-section py-5">
  <div className="container px-md-5 px-3">
    ...
    <div className="slider-wrapper position-relative">
      ...
      >
        {sliderStories && sliderStories.map((story) => (
          <div
          ...
          >
            ...
            >
              <div className="small-card-img" style={{ minHeight: '150px' }}>
                <img
    ...
    <div className="text-center mt-4">
     ...
     {/* --- 4. नाट्य मंच (Natak Section) --- */}
      <section className="natak-section-wrapper" style={{ width: "100%", overflowX: "hidden" }}>
                ...
                <Link to={`/read/${natak.authorId}/${natak.title}`} className="text-decoration-none">
                  <div className="natak-square-card text-center border-0">
                    <div className="square-frame shadow-sm mb-3">
                      <img
                        /* ✅ पाथ ठीक किया: /covers/ फोल्डर से उठाएगा */
                        src={natak.img ? `/covers/${natak.img}` : "/covers/kafan.jpg"}
                        alt={natak.title}
                        className="img-fluid w-100 h-100"
                        style={{ objectFit: "cover" }}
                        onError={(e) => {
                          e.target.onerror = null;
                          e.target.src = "/covers/kafan.jpg";
                        }}
                      />
                    </div>
                    <h6 className="natak-title-v2 px-1 text-dark" style={{ lineHeight: "1.6" }}>
                      {natak.title}
                    </h6>
                  </div>
                </Link>
