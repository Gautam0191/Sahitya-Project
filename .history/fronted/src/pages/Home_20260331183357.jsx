          ...
          >
            <div className="row g-0">
              <div className="col-md-6 overflow-hidden featured-img-box">
                <img
                  /* यहाँ 'cover' को 'covers' किया और बैकअप के लिए kafan.jpg लगाया */
                  src={featuredStory.img ? `/covers/${featuredStory.img.trim()}` : "/covers/kafan.jpg"}
          ...
          >
            ...
            >
              <div className="small-card-img">
                <img
                  /* यहाँ भी 'covers' फोल्डर का सही पाथ */
                  src={story.img ? `/covers/${story.img.trim()}` : "/covers/kafan.jpg"}
