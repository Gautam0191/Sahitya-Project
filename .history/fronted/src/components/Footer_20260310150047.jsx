          ...
          <div className="row gy-4">
            <div className="col-6 col-md-3 col-lg-2">
              ...
              <ul className="footer-links list-unstyled">
                <li>
                  <Link to="/kavi">कवि</Link>
                </li>
                <li>
                  <Link to="/poems">कविता</Link>
                </li>
                <li>
                  <Link to="/stories">कहानी</Link>
                </li>
                <li>
                  <Link to="/dohe">दोहा</Link>
                </li>
              </ul>
            </div>
            ...
            <div className="col-6 col-md-3 col-lg-2">
              ...
              <ul className="footer-links list-unstyled">
                <li>
                  <Link to="/about">साइट परिचय</Link>
                </li>
                <li>
                  <Link to="/contact">संपर्क कीजिए</Link>
                </li>
                <li>
            ...
            <div className="col-6 col-md-3 col-lg-2">
              ...
              <ul className="footer-links list-unstyled">
                <li>
                  <Link to="/bhakti-kavya">भक्ति काव्य</Link>
                </li>
                <li>
                  <Link to="/veer-ras">वीर रस</Link>
                </li>
                <li>
                  <Link to="/chhayavad">छायावाद</Link>
                </li>
              </ul>
            </div>
