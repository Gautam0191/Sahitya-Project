...
export const nibandhData = [
  ...
  },
  {
    ...
    category: "nibandhkar",
    img: "/images/dwivedi.jpg",
    bio: "हजारी प्रसाद द्विवेदी जी अपने ललित निबंधों के लिए प्रसिद्ध हैं।",
    works: ["कुटज", "अशोक के फूल", "कल्पलता"], // सीधा नाम लिखें
  },
];

export const sherData = [{ id: 601,
    name: "मिर्ज़ा ग़ालिब",
    category: "shayar",
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Ghalib_portrait.jpg/220px-Ghalib_portrait.jpg",
...
export const doheData = [{id: 701,
    name: "कबीर दास",
    category: "kavi",
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/Kabir_-_Saint_of_India.jpg/220px-Kabir_-_Saint_of_India.jpg",
...
export const authorsData = [{ id: 801, name: "प्रेमचंद", img: "url" }];

export const geetkarData = [{ id: 901,
    name: "अमीर ख़ुसरो",
    category: "geetkar",
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Amir_Khusrow_portrait.jpg/220px-Amir_Khusrow_portrait.jpg",
    ...
    works: ["खालिक़ बारी", "नूह सिपिहर", "छाप तिलक सब छीनी", "पहेलियाँ और मुकरियाँ"] }];
