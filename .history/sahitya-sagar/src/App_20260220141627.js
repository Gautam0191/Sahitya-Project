...
function App() {
  ...
  if (authorScrollRef.current) {
    ...
    // यहाँ functional update का उपयोग करें ताकि ये फंक्शन खुद किसी बाहरी स्टेट पर निर्भर न रहे
    setShowPrevAuthor(prev => {
      const newVal = scrollLeft > 10;
      return prev !== newVal ? newVal : prev;
    });
    setShowNextAuthor(prev => {
      const newVal = scrollLeft < scrollWidth - clientWidth - 25;
      return prev !== newVal ? newVal : prev;
    });
  }
}, []);
