...
export const poetryData = [
  { id: 1, title: "शहर नक्शे से नहीं, यात्राओं से पहचाने जाते हैं", poet: "राशि पांडेय", img: "https://images.unsplash.com/photo-1519791883288-dc8bd696e667?w=500" },
  { id: 2, title: "न नदी का विद्रोह: एक अनकही कहानी", poet: "माणिक बंदोपाध्याय", img: "https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?w=500" },
  { id: 3, title: "बालमुकुंद गुप्त के भूले-बिसरे साहित्य घराने", poet: "सुधीर पचौरी", img: "https://images.unsplash.com/photo-1506466010722-395aa2bef877?w=500" },
  { id: 4, title: "चार नाम, एक इंक़लाब: अमर गाथा", poet: "अर्जुन पांडेय", img: "https://images.unsplash.com/photo-1516979187457-637abb4f9353?w=500" },
  { id: 5, title: "कलम की धार और समाज का सच", poet: "अज्ञात", img: "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=500" },
  { id: 6, title: "साहित्य की नई लहर", poet: "लेखक का नाम", img: "https://images.unsplash.com/photo-1512820790803-83ca734da794?w=500" },
  { id: 7, title: "पुरानी यादें", poet: "लेखक का नाम", img: "https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?w=500" },
  { id: 8, title: "गाँव की मिट्टी", poet: "लेखक का नाम", img: "https://images.unsplash.com/photo-1506466010722-395aa2bef877?w=500" },
  { id: 9, title: "अनकहे शब्द", poet: "लेखक का नाम", img: "https://images.unsplash.com/photo-1544640808-32ca72ac7f37?w=500" },
  { id: 10, title: "सांध्य गीत", poet: "लेखक का नाम", img: "https://images.unsplash.com/photo-1519791883288-dc8bd696e667?w=500" },
];
...
export const sliderStories = [
  ...
  { id: 4, title: "बालापुर युद्ध...", date: "20 दिसंबर 2025", img: "https://images.unsplash.com/photo-1503264116251-35a269479413?w=400" },
  { id: 5, title: "नई कहानी", date: "19 दिसंबर 2025", img: "https://images.unsplash.com/photo-1512820790803-83ca734da794?w=400" },
];
...
export const navbarPoetsData = [
  ...
  { id: 103, name: "शमशेर बहादुर सिंह", img: "https://dummyimage.com/200x200/f0f0f0/666&text=शमशेर" },
  { id: 104, name: "रघुवीर सहाय", img: "https://dummyimage.com/200x200/f0f0f0/666&text=रघुवीर" },
  { id: 105, name: "केदारनाथ अग्रवाल", img: "https://dummyimage.com/200x200/f0f0f0/666&text=केदारनाथ" },
  ...
  { id: 113, name: "सुभद्रा कुमारी", img: "/authors/subhdhra-kumari-chauhan.jpg" },
  { id: 114, name: "महादेवी वर्मा", img: "/authors/mhadevi-varma.jpg" },
...
export const navbarStorytellersData = [
  ...
  { id: 202, name: "यशपाल", img: "https://dummyimage.com/200x200/f0f0f0/666&text=यशपाल" },
  { id: 203, name: "भीष्म साहनी", img: "/authors/Bhisham-Sahni.jpg" },
  { id: 204, name: "मन्नू भंडारी", img: "https://dummyimage.com/200x200/f0f0f0/666&text=मन्नू" },
  { id: 205, name: "कमलेश्वर", img: "https://dummyimage.com/200x200/f0f0f0/666&text=कमलेश्वर" },
];

export const navbarNatakData = [
  { id: 301, name: "मोहन राकेश", img: "https://dummyimage.com/200x200/f0f0f0/666&text=मोहन" },
  { id: 302, name: "धर्मवीर भारती", img: "https://dummyimage.com/200x200/f0f0f0/666&text=धर्मवीर" },
  { id: 303, name: "विजय तेंदुलकर", img: "https://dummyimage.com/200x200/f0f0f0/666&text=विजय" },
];

export const navbarGeetData = [
  { id: 401, name: "नीरज", img: "https://dummyimage.com/200x200/f0f0f0/666&text=नीरज" },
  { id: 402, name: "गुलज़ार", img: "https://dummyimage.com/200x200/f0f0f0/666&text=गुलज़ार" },
];

// --- 8. नाटक और विधा डेटा ---
export const natakData = [
  { id: 1, title: "आषाढ़ का एक दिन", type: "ऐतिहासिक नाटक", img: "https://picsum.photos/id/452/600/600" },
  { id: 2, title: "अंधा युग", type: "काव्य नाटक", img: "https://picsum.photos/id/1043/600/600" },
  { id: 3, title: "खामोश! अदालत जारी है", type: "सामाजिक नाटक", img: "https://picsum.photos/id/635/600/600" },
  { id: 4, title: "चंद्रगुप्त", type: "ऐतिहासिक नाटक", img: "https://picsum.photos/id/1029/600/600" },
  { id: 5, title: "कोणार्क", type: "पौराणिक नाटक", img: "https://picsum.photos/id/1015/600/600" },
];
...
export const nibandhData = [
  { id: "501", name: "रामचंद्र शुक्ल", category: "nibandhkar", img: "/authors/acharya-ramchandra-shukla.jpg", bio: "आचार्य रामचंद्र शुक्ल हिंदी साहित्य के सर्वश्रेष्ठ निबंधकार और आलोचक हैं।", works: ["चिंतामणि", "उत्साह", "कविता क्या है"] },
  { id: "502", name: "हजारी प्रसाद द्विवेदी", category: "nibandhkar", img: "/authors/hajari-prasadh.jpg", bio: "हजारी प्रसाद द्विवेदी जी अपने ललित निबंधों के लिए प्रसिद्ध हैं।", works: ["कुटज", "अशोक के फूल"] },
];

export const geetkarData = [
  { id: 901, name: "अमीर ख़ुसरो", category: "geetkar", img: "/authors/amir-khusro.jpg", bio: "अमीर ख़ुसरो चौदहवीं सदी के प्रमुख कवि, गायक और संगीतकार थे।", works: ["खालिक़ बारी", "छाप तिलक सब छीनी"] },
];
...
export const doheData = [{ id: 701, name: "कबीर दास", category: "kavi", img: "/authors/kaveer.jpg", bio: "संत कबीर", works: ["बीजक", "साखी"] }];
