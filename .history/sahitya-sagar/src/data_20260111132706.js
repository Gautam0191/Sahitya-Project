...
export const nibandhData = [
  ...
  },
  {
    ...
    works: [
      { id: 201, title: "कुटज", type: "निबंध" },
      { id: 202, title: "अशोक के फूल", type: "निबंध" }
    ]
  }
];

export const sherData = [
  { id: 601, name: "मिर्ज़ा ग़ालिब", img: "url" },
];

export const doheData = [
  { id: 701, name: "कबीर दास", img: "url" },
];

export const authorsData = [
  { id:801 , name: "प्रेमचंद", img: "url" },
];

export const geetkarData = [
  { id: 901, name: "गुलज़ार", img: "url" },
];
