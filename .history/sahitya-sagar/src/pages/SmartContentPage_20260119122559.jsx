...
useEffect(() => {
  const fetchAuthors = async () => {
    try {
      setLoading(true);
      setData([]); // 👈 नया डेटा लाने से पहले पुराना डेटा साफ़ करें
      ...
      console.log(`Backend Data for ${type}:`, response.data); // चेक करने के लिए
  ...
  if (type) fetchAuthors(); // सिर्फ तभी कॉल करें जब type मौजूद हो
}, [type]);

// रूटिंग के लिए इसे सरल रखें
const getTargetRoute = () => {
  const mapping = {
    poetry: "kavita",
    story: "kahani",
    sher: "shayar", // ✅ यहाँ 'shayar' रूट पर भेजें
    dohe: "sant"     // ✅ यहाँ 'sant' रूट पर भेजें
  };
