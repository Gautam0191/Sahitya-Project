            ...
            <div className="row g-0">
              <div className="col-md-6 overflow-hidden featured-img-box">
                <img
                  src={
                    featuredStory.img
                      ? `http://localhost:5000/${featuredStory.img}` // 👈 यहाँ से covers/ हटा दिया क्योंकि DB में पहले से है
                      : "/placeholder.jpg"
                  }
            ...
            >
              <div className="small-card-img">
                <img
                  src={
                    story.img
                      ? `http://localhost:5000/${story.img}` // 👈 यहाँ भी सीधा DB पाथ इस्तेमाल किया है
                      : "/placeholder.jpg"
                  }
