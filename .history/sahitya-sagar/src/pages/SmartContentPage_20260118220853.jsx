  ...
  useEffect(() => {
    const fetchAuthors = async () => {
      try {
        ...
        // ✅ यहाँ हमने URL बदला है ताकि होमपेज का डेटा न बिगड़े और यहाँ सिर्फ पसंदीदा लेखक आएँ
        const response = await axios.get(`http://localhost:5000/api/featured-authors-by-type?category=${type}`);
        
        // डेटा सेट करना (बैकएंड से पहले ही 11 की लिमिट लगी है)
    ...
    <div className="container mt-5 pt-5">
      ...
      <div className="row g-2">
        ...
        {!loading && data.length > 0 ? (
          ...
          <p className="ps-3 text-muted">इस श्रेणी में कोई पसंदीदा लेखक नहीं मिला।</p>
        )}
      </div>
    </div>
  );
