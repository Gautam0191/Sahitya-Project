...
const Home = ({
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // 1. कहानी का लॉजिक (Featured Story)
        ...
        // 2. कविता का लॉजिक (Featured/Favorite Logic) ✅
        let poetryData = poetryRes.data || [];
        // यहाँ हम डेटा को ऐसे सॉर्ट कर रहे हैं कि isFeatured वाली कविताएँ सबसे ऊपर आएँ
        const sortedPoetry = [...poetryData].sort((a, b) => (b.isFeatured === true ? 1 : -1));

        // 3. स्टेट्स अपडेट करें
  ...
  }, [loading, favoriteAuthors.length, handleAuthorScroll]);
  ...
  return (
    <>
      ...
      <section className="poetry-section container mt-5 pb-5">
                ...
                <div className="poetry-card-v2 shadow-sm h-100">
                  <div className="card-img-wrapper">
                    <img
                      ...
                      className="img-fluid"
                      loading="lazy"
                      // ब्लिंकिंग रोकने के लिए onError को यहाँ सरल रखा है ✅
                      onError={(e) => { 
        ...
        {/* बटन तभी दिखेगा जब डेटा दिखाने की सीमा से ज़्यादा हो */}
