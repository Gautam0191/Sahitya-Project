  ...
  return (
    <div className="container mt-5 pt-5">
      ...
      <div className="text-start mb-4">
        <h1 className="display-5 fw-bold" style={{ color: "#b32d2e", fontFamily: 'serif' }}>
          {title}
        </h1>
      ...
      <div className="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
        ...
        <span className="text-primary fw-bold" style={{ cursor: 'pointer', fontSize: '0.9rem' }}>समस्त</span>
      </div>
            ...
            >
              <div className="square-img-box">
                <img 
                  src={item.img} 
                  alt={item.name} 
                  onError={(e) => { e.target.src="https://via.placeholder.com/200?text=Sahitya+Sagar" }}
                />
              </div>
