    ...
    <div className="author-detail-page">
      ...
      <div className="author-header py-5 bg-dark text-white text-center">
        <div className="container">
          <div className="author-img-large mb-4 mx-auto shadow-lg" style={{ width: '200px', height: '200px', overflow: 'hidden', borderRadius: '50%' }}>
          ...
          <span className="badge rounded-pill bg-light text-dark px-4 py-2 mb-4">{author.categoryLabel || "साहित्यकार"}</span>
          
          <div className="d-flex flex-wrap justify-content-center gap-3">
             <div className="bg-secondary p-2 rounded">जन्म: {author.birthDate || "अज्ञात"}</div>
             <div className="bg-secondary p-2 rounded">स्थान: {author.birthPlace || "भारत"}</div>
          </div>
        </div>
      </div>
        ...
        <div className="row g-5">
          ...
          <div className="col-lg-7">
            <div className="bio-card p-4 bg-white shadow-sm rounded-4 border">
              ...
              <p className="lh-lg fs-5 text-secondary" style={{ textAlign: "justify" }}>
              ...
              {author.structuredWorks ? (
                Object.entries(author.structuredWorks).map(([catName, items]) => (
                  <div key={catName} className="mb-4">
                    <h5 className="text-uppercase text-danger fw-bold">{catName}</h5>
                    <div className="list-group list-group-flush">
                      {items.map((item, idx) => (
                        ...
                        >
                          ...
                          <span className="text-primary text-decoration-underline-hover">{item}</span>
                        </button>
                      ))}
                    </div>
                  </div>
