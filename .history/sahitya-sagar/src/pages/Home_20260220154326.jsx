  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // --- ✅ कविता का लॉजिक: isFeatured वाली कविताएँ सबसे पहले आएंगी ---
        let sortedPoetry = [];
        if (poetryRes.data) {
          sortedPoetry = [...poetryRes.data].sort((a, b) => (b.isFeatured === true ? 1 : -1));
        }

        // 3. स्टेट्स को एक साथ अपडेट करें
  ...
  return (
    <>
      ...
      <section className="poetry-section container mt-5 pb-5">
        ...
        {/* ✅ बटन तभी दिखेगा जब डेटा दिखाने की लिमिट से ज़्यादा हो */}
      ...
      {/* ... बाकी का कोड (Drama, Authors आदि) इसके नीचे पेस्ट कर लेना ... */}
    </>
  );
};
