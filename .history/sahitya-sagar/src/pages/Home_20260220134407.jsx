                ...
                >
                  <div className="row g-0">
                    <div className="col-md-6 overflow-hidden featured-img-box">
                      <img
  // यहाँ से /covers/ हटा दिया क्योंकि तुम्हारे डेटा में वो पहले से है
  src={featuredStory.img ? `http://localhost:5000/${featuredStory.img}` : "/placeholder.jpg"}
                  ...
                  >
                    <div className="small-card-img">
                      <img
                        ...
                        src={
                          story.img
                            ? `http://localhost:5000/covers/${story.img}`
                            : "/placeholder.jpg"
                        }
