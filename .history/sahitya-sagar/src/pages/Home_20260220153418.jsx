...
<section className="poetry-section container mt-5 pb-5">
  ...
  <div className="row g-3 row-cols-2 row-cols-md-3 row-cols-lg-5 justify-content-center">
    {dbPoetry
      /* ✅ मोबाइल पर पहले 6, और डेस्कटॉप पर पहले 10 (अगर showAll false है तो) */
        ...
        >
          <div className="poetry-card-v2 shadow-sm h-100">
            <div className="card-img-wrapper">
              <img
                /* ✅ सीधा इमेज पाथ (Reading page की तरह) */
  ...
  {/* ✅ 'सारे देखें' बटन: अब यह मोबाइल और डेस्कटॉप दोनों पर काम करेगा अगर डेटा ज्यादा है */}
  <div className="text-center mt-5">
    <button
      className="premium-btn"
      onClick={() => {
        setShowAll(!showAll);
        // अगर 'कम देखें' क्लिक किया है, तो वापस ऊपर स्क्रॉल हो जाए (Optional)
