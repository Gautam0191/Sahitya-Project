...
const AuthorDetailPage = () => {
  ...
  try {
    ...
    console.log("All Authors From API:", response.data); // इसे कंसोल में चेक करें

    // थोड़ा ढीला मैच (Double Equals) रखें ताकि String/Number का लफड़ा न हो
      ...
      <div className="author-header py-5">
        <div className="container text-center text-white">
          <div className="author-img-large mb-4 mx-auto shadow-lg">
            <img 
  src={author.img.startsWith('http') ? author.img : `${window.location.origin}${author.img}`} 
  alt={author.name} 
