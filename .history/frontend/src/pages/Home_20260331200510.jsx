        ...
        <div className="col-12 col-xl-11">
          ...
          >
            <div className="row g-0">
              <div className="col-md-6 overflow-hidden featured-img-box" style={{ background: '#f0f0f0', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <img
                  /* ✅ SMART PATH: अगर डेटा में पहले से /covers/ है तो दोबारा नहीं जोड़ेगा */
                  src={
                    featuredStory.img 
                      ? (featuredStory.img.includes('covers/') ? featuredStory.img.trim() : `/covers/${featuredStory.img.trim()}`)
                      : ""
                  }
            ...
            >
              ...
              >
                <div
                  ...
                  style={{ minHeight: "150px", display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f9f9f9' }}
                >
                  <img
                    /* ✅ यहाँ भी वही स्मार्ट पाथ लॉजिक */
                    src={
                      story.img 
                        ? (story.img.includes('covers/') ? story.img.trim() : `/covers/${story.img.trim()}`)
                        : ""
                    }
