...
>
  ...
  <button className="carousel-control-next" type="button" data-bs-target="#heroCarousel" data-bs-slide="next">
    <span className="carousel-control-next-icon"></span>
      ...
      {/* --- 2. कविता सेक्शन --- */}
      <section className="poetry-section py-5">
  <div className="container px-md-5 px-3">
    <div className="section-header text-center mb-5">
      <h2 className="display-5 fw-bold section-title">काव्य-कोश</h2>
      <p className="text-muted section-subheading">हिंदी साहित्य की चुनिंदा रचनाएं</p>
