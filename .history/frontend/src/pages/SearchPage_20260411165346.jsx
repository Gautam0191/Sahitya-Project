...
useEffect(() => {
    const fetchGlobalData = async () => {
      ...
      try {
        ...
        // 2. Render API कॉल (Params के साथ)
        const res = await axios.get(`https://sahitya-backend.onrender.com/api/content/all/search`, {
          params: { q: cleanQuery }
        });

        console.log("Data received from API:", res.data);

        // 3. पक्का करें कि डेटा Array ही है
        ...
        console.error("सर्च एरर विवरण:", err);
        setAllResults([]);
      } finally {
        setLoading(false);
      }
