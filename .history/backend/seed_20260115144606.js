...
const { navbarPoetsData, navbarStorytellersData, navbarNatakData } = require('./authorsData');

// सारा डेटा एक लिस्ट में मिला लें
const allAuthors = [...navbarPoetsData, ...navbarStorytellersData, ...navbarNatakData];
